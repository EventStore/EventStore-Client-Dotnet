...
If you're looking for the TCP client library (legacy), check the [EventStoreDB repository v5 branch](https://github.com/EventStore/EventStore/tree/v5-master).
