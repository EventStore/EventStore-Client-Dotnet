...
public class update_existing_with_check_point_obsolete
	: IClassFixture<update_existing_with_check_point_obsolete.Fixture> {
	const    string  Stream = nameof(update_existing_with_check_point_obsolete);
	const    string  Group  = "existing-with-check-point";
	readonly Fixture _fixture;

	public update_existing_with_check_point_obsolete(Fixture fixture) => _fixture = fixture;
