...
public class connect_to_existing_with_start_from_not_set_and_events_in_it_then_event_written
	...
	const string Stream = nameof(connect_to_existing_with_start_from_not_set_and_events_in_it_then_event_written);

	readonly Fixture _fixture;

	public
		connect_to_existing_with_start_from_not_set_and_events_in_it_then_event_written(Fixture fixture) =>
		_fixture = fixture;
