...
public class happy_case_catching_up_to_normal_events_manual_ack : IClassFixture<happy_case_catching_up_to_normal_events_manual_ack.Fixture> {
    const string Stream          = nameof(happy_case_catching_up_to_normal_events_manual_ack);
