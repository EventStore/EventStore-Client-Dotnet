...
public class connect_to_existing_with_start_from_two_and_no_stream_obsolete
	...
	const string Stream =
		nameof(connect_to_existing_with_start_from_two_and_no_stream_obsolete);

	readonly Fixture _fixture;

	public connect_to_existing_with_start_from_two_and_no_stream_obsolete(Fixture fixture) => _fixture = fixture;
