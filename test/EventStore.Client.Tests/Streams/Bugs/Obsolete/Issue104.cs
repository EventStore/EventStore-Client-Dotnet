namespace EventStore.Client.Tests.Bugs.Obsolete;

[Trait("Category", "Bug")]
[Obsolete("Tests will be removed in future release when older subscriptions APIs are removed from the client")]
public class Issue104(ITestOutputHelper output, KurrentPermanentFixture fixture) : EventStorePermanentTests<KurrentPermanentFixture>(output, fixture) {
	[Fact]
