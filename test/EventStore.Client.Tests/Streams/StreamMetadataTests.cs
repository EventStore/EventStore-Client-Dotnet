...
public class StreamMetadataTests(ITestOutputHelper output, KurrentPermanentFixture fixture) : EventStorePermanentTests<KurrentPermanentFixture>(output, fixture) {
	[Fact]
