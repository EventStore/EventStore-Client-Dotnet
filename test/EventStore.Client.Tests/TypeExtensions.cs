...
namespace EventStore.Client {
	internal static class TypeExtensions {
		...
		public static bool InvokeInequalityOperator(this Type type, object? left, object? right) =>
			type.InvokeOperator("Inequality", left, right);

		public static bool InvokeGreaterThanOperator(this Type type, object? left, object? right) =>
			type.InvokeOperator("GreaterThan", left, right);

		public static bool InvokeLessThanOperator(this Type type, object? left, object? right) =>
			type.InvokeOperator("LessThan", left, right);

		public static bool InvokeGreaterThanOrEqualOperator(this Type type, object? left, object? right) =>
			type.InvokeOperator("GreaterThanOrEqual", left, right);

		public static bool InvokeLessThanOrEqualOperator(this Type type, object? left, object? right) =>
			type.InvokeOperator("LessThanOrEqual", left, right);
		...
		public static bool ImplementsGenericIComparable(this Type type) =>
			type.GetInterfaces().Any(t => t == typeof(IComparable<>).MakeGenericType(type));
