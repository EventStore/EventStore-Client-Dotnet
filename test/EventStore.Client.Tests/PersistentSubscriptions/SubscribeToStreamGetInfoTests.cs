...
public class SubscribeToStreamGetInfoTests(SubscribeToStreamGetInfoTests.NoDefaultCredentialsFixture fixture)
	: IClassFixture<SubscribeToStreamGetInfoTests.NoDefaultCredentialsFixture> {
	...
	public class NoDefaultCredentialsFixture : KurrentTemporaryFixture {
		...
		EventStorePersistentSubscriptionsClient.PersistentSubscriptionResult? Subscription;
		IAsyncEnumerator<PersistentSubscriptionMessage>?                      Enumerator;

		public NoDefaultCredentialsFixture() : base(x => x.WithoutDefaultCredentials()) {
			Group  = GetGroupName();
