...
public class read_stream_security : IClassFixture<SecurityFixture> {
	public read_stream_security(ITestOutputHelper output, SecurityFixture fixture) => Fixture = fixture.With(x => x.CaptureTestRun(output));
