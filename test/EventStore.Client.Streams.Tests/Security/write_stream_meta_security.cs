...
public class write_stream_meta_security : IClassFixture<SecurityFixture> {
	public write_stream_meta_security(ITestOutputHelper output, SecurityFixture fixture) => Fixture = fixture.With(x => x.CaptureTestRun(output));
