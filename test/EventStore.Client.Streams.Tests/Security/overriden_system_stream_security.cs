...
public class overriden_system_stream_security : IClassFixture<overriden_system_stream_security.CustomFixture> {
	public overriden_system_stream_security(ITestOutputHelper output, CustomFixture fixture) =>
