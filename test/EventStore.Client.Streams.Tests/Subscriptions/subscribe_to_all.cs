...
public class subscribe_to_all : IClassFixture<subscribe_to_all.CustomFixture> {
	/// <summary>
	/// This class because it checks $all, requires a dedicated db node for each test.
	/// </summary>
	public subscribe_to_all(ITestOutputHelper output, CustomFixture fixture) =>
