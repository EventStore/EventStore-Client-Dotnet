...
namespace EventStore.Client {
	...
	public abstract class EventStoreClientBase :
		...
		private readonly SharingProvider<GrpcChannelInput, ChannelInfo>    _channelInfoProvider;
		private          Lazy<HttpFallback>                                _httpFallback;
		...
		protected EventStoreClientBase(
			...
			_channelInfoProvider = new SharingProvider<GrpcChannelInput, ChannelInfo>(
		...
		private async Task<ChannelInfo> GetChannelInfoExpensive(
			GrpcChannelInput grpcChannelInput,
			Action<GrpcChannelInput> onReconnectionRequired,
