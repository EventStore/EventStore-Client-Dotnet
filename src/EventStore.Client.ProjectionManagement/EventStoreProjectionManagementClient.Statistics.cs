...
public partial class EventStoreProjectionManagementClient {
	...
	/// <returns></returns>
	public IAsyncEnumerable<ProjectionDetails> ListOneTimeAsync(
	...
	/// <param name="cancellationToken"></param>
	/// <returns></returns>
	public IAsyncEnumerable<ProjectionDetails> ListContinuousAsync(
		TimeSpan? deadline = null,
	...
	/// <param name="cancellationToken"></param>
	/// <returns></returns>
	public Task<ProjectionDetails?> GetStatusAsync(
		string name,
	...
	/// <param name="cancellationToken"></param>
	/// <returns></returns>
	public IAsyncEnumerable<ProjectionDetails> ListAllAsync(
		TimeSpan? deadline = null,
		UserCredentials? userCredentials = null, CancellationToken cancellationToken = default
	) =>
		ListInternalAsync(
	...
	async IAsyncEnumerable<ProjectionDetails> ListInternalAsync(
        ...
        using var call = new Projections.Projections.ProjectionsClient(channelInfo.CallInvoker)
            .Statistics(new StatisticsReq { Options = options }, callOptions);
