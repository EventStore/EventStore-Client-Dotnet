...
public struct StreamMetadataResult : IEquatable<StreamMetadataResult> {
	...
	/// <returns></returns>
	public static StreamMetadataResult None(string streamName) => new(streamName);
	...
	public static StreamMetadataResult Create(
		string streamName, StreamPosition revision,
		StreamMetadata metadata
	) => new(streamName, revision, metadata);

	StreamMetadataResult(
		string streamName, StreamPosition? metastreamRevision = null,
