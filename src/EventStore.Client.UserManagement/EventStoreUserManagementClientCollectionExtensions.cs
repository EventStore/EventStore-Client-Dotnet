...
public static class EventStoreUserManagementClientCollectionExtensions {
	...
	public static IServiceCollection AddEventStoreUserManagementClient(
	...
	) => services.AddEventStoreUserManagementClient(EventStoreClientSettings.Create(connectionString), configureSettings);
	...
	/// <exception cref="ArgumentNullException"></exception>
	public static IServiceCollection AddEventStoreUserManagementClient(
		this IServiceCollection services, Action<EventStoreClientSettings>? configureSettings = null
	) => services.AddEventStoreUserManagementClient(new EventStoreClientSettings(), configureSettings);

	static IServiceCollection AddEventStoreUserManagementClient(
		this IServiceCollection services, EventStoreClientSettings settings, Action<EventStoreClientSettings>? configureSettings = null
	) {
